...
export default function PlanCard({ plan, user, onSelect, selectedInterval }: Props) {
  ...
  return (
    <Card
      className={`relative flex flex-col justify-between transition-all grow sm:min-w-[280px] max-w-[400px] duration-500 rounded-2xl border shadow-lg hover:shadow-2xl hover:-translate-y-2 group
        ${
          plan.mostPopular
